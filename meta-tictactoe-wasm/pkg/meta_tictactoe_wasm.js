...
export class GameStateWrapper {
    ...
    */
    apply_move(mov) {
        ...
        const ret = wasm.gamestatewrapper_apply_move(this.__wbg_ptr, mov.__wbg_ptr);
        return ret !== 0;
    }
    /**
    * @param {MetaMove} mov
    ...
    * @returns {boolean}
    */
    apply_json_move(move_js) {
        const ret = wasm.gamestatewrapper_apply_json_move(this.__wbg_ptr, addHeapObject(move_js));
        return ret !== 0;
    }
    /**
    * @returns {any}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('meta_tictactoe_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
